...
- **Module:** `python -m ingestion.scripts.download_filings`
...
- **Module:** `python -m ingestion.scripts.process_all_filings`
- Orchestrates steps 2-4, writes chunks to JSONL

### 6. Ingest (Qdrant)

- **Module:** `python -m ingestion.scripts.ingest`
...
- **Module:** `python -m ingestion.scripts.run_neo4j_pipeline`
